...
<tr>
	  <td width="100%">
		...
		{if $istopics}
			...
			echo "		  <td width=\"50%\" align=\"center\" ><a href=\"team-forum.php?command=readtopic&topic_id=$topicid[$i]#$postid[$i]\"><font color=\"white\" size=\"2\"><b>$topictypes[$i] $topictitle[$i]</b></font></a></td>";
			  ...
			  <td width="100%" align="center" bgcolor="black" bordercolorlight="black">
				<div align="center">
				  <table border="0" cellspacing="1" width="100%" bordercolorlight="black" cellpadding="0">
					<tr>
					  <td width="100%" align="center" valign="middle"><A class="but" HREF="team-forum.php?command=posttopic">{$l_forums_posttopic}</A>
					  </td>
					</tr>
				  </table>
				</div>
