...
<tr><td colspan=2 align=center valign=top><font size=2 face="courier new" color=#ff0000>{$l_igb_transfertype}<br>---------------------------------</td></tr>
<tr valign=top>
<form action=igb.php?command=transfer2 method=POST>
<td><font size=2 face="courier new" color=#ff0000>{$l_igb_toanothership} :<br><br>
...
<tr valign=top>
<td><br><font size=2 face="courier new" color=#ff0000>{$l_igb_fromplanet} :<br><br>
<form action=igb.php?command=transfer2 method=POST>
...
<tr valign=top>
<td><br><font size=2 face="courier new" color=#ff0000>{$l_igb_conspl} :<br><br>
