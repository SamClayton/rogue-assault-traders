...
<tr valign=top>
<td><font size=2 face="courier new" color=#ff0000>{$l_igb_seldepositamount} :</td><td align=right>
...
{if $max_igb_storage > 0}
	<tr><td><font size=2 face="courier new" color=#ff0000>{$l_igb_maximum} {$l_igb_igbaccount} {$l_credits}: </font><font size=2 face="courier new" color=#ffFF00>{$max_igb_storage}</font><td><tr>
{/if}
<tr valign=bottom>
