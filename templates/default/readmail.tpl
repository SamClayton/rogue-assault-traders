	  ...
	  <td width="100%">
		<div align="center">
		  ...
		  <table border="0" cellspacing="1" width="100%">
			...
			echo "		  <td width=\"4%\" height=\"19\" align=\"center\" bordercolorlight=\"black\" bordercolordark=\"black\"><A class=\"but\" HREF=\"readmail.php?action=delete&ID=$msgid[$i]\"><img src=\"templates/$templatename/images/c95x.png\" width=\"16\" height=\"14\" border=\"0\"></a></td>";
			echo "		</tr>";
			echo "	  </table>";
			echo "	</div>";
			echo "  </td>";
			...
			echo "		<tr>";
			echo "		  <td width=\"100%\" align=\"center\" valign=\"middle\"><A class=\"but\" HREF=\"readmail.php?action=delete&ID=$msgid[$i]\">$l_readm_del</A> |";
			if($senderid[$i] != 0){
			if($senderid[$i] > 3)
				echo "				<A class=\"but\" HREF=\"readmail.php?name=$senderid[$i]&msgid=$msgid[$i]&action=block\">$l_readm_block</A> |";
			echo "				<A class=\"but\" HREF=\"mailto2.php?name=$senderid[$i]&msgid=$msgid[$i]&quote=0\">$l_readm_repl</A> |";
			echo "				<A class=\"but\" HREF=\"mailto2.php?name=$senderid[$i]&msgid=$msgid[$i]&quote=1\">$l_readm_quote</A>";
			}
			echo "		  </td>";
			echo "		</tr>";
			echo "	  </table>";
				...
				<div align="center">
				  <table border="0" cellspacing="1" width="100%" bgcolor="#000000" bordercolorlight="#000000" bordercolordark="#C0C0C0" height="8">
					<tr>
					  ...
					  <td width="50%"><p align="right"><font color="#FFFFFF" size="2"><A class="but" HREF="readmail.php?action=delete_all">{$l_readm_delete}</a></font></td>
					</tr>
				  </table>
				</div>
			  </td>
