<?php
if (preg_match("/port_organics.php/i", $_SERVER['PHP_SELF'])) 
{
	...
	$energy_price = $sectorinfo['energy_price'] + $energy_price + $energy_delta * $energy_limit / $energy_limit * $inventory_factor;
	...
	cleanjs('');
	echo $cleanjs;
	echo "<FORM ACTION=port_purchase_organics.php METHOD=POST>";
